...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Character> characters)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
return loaded(_that.characters);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Character> characters)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case Initial():
return initial();case Loading():
return loading();case Loaded():
return loaded(_that.characters);case Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Character> characters)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Initial implements CollectionsState {
  const Initial();
...
class Loading implements CollectionsState {
  const Loading();
...
class Loaded implements CollectionsState {
  const Loaded(final  List<Character> characters): _characters = characters;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Loaded&&const DeepCollectionEquality().equals(other._characters, _characters));
}
...
@override
String toString() {
  return 'CollectionsState.loaded(characters: $characters)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $CollectionsStateCopyWith<$Res> {
...
class Error implements CollectionsState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $CollectionsStateCopyWith<$Res> {
