...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeListState);
}
...
/// @nodoc
class $HomeListStateCopyWith<$Res>  {
$HomeListStateCopyWith(HomeListState _, $Res Function(HomeListState) __);
}


/// Adds pattern-matching-related methods to [HomeListState].
extension HomeListStatePatterns on HomeListState {
...
class _Initial implements HomeListState {
  const _Initial();
